...
/** Parses mpd compiler errors into VS Code diagnostics (red squiggles). */
export class MicroPandaDiagnostics implements vscode.Disposable {
    private readonly collection =
        vscode.languages.createDiagnosticCollection('micro-panda');
